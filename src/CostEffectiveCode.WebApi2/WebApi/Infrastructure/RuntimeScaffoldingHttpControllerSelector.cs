...
using AllowScaffoldAttribute = CostEffectiveCode.WebApi2.Attributes.AllowScaffoldAttribute;
using DenyScaffoldAttribute = CostEffectiveCode.WebApi2.Attributes.DenyScaffoldAttribute;
using RuntimeScaffoldingApproach = CostEffectiveCode.WebApi2.Attributes.RuntimeScaffoldingApproach;

namespace CostEffectiveCode.WebApi2.WebApi.Infrastructure
{
    public class RuntimeScaffoldingHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        private HttpControllerDescriptor TryFallbackToDefaultController(HttpRequestMessage request)
        {
            ...
            var entityApiControllerType = typeof(Controller.EntityApiController<,>).MakeGenericType(entityType, pkType);
