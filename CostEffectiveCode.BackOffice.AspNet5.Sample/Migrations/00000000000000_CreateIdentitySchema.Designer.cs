...
using CostEffectiveCode.BackOffice.AspNet5.Sample.Models;

namespace CostEffectiveCode.BackOffice.AspNet5.Sample.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("CostEffectiveCode.BackOffice.AspNet5.Sample.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("CostEffectiveCode.BackOffice.AspNet5.Sample.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
